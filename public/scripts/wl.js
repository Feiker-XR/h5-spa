...
$(function () {
   ...
   // $("#outer-container .content").css({ "transform": "scale(" + scale + ")", "left": (window.innerWidth - scale * 640) / 2 + "px", "top": (window.innerHeight - scale * 1008) / 2 + "px", "-ms-transform": "scale(" + scale + ")", "-moz-transform": "scale(" + scale + ")", "-webkit-transform": "scale(" + scale + ")", "-o-transform": "scale(" + scale + ")" });  //scale and center
    ...
    var imgsstr = ["./../public/images/wl/theme1.png", "./../public/images/wl/theme2.png", "./../public/images/wl/theme3.png", "./../public/images/wl/theme4.png", "./../public/images/wl/theme5.png", "./../public/images/wl/theme6.png", "./../public/images/wl/theme7.png", "./../public/images/wl/theme8.png", "./../public/images/wl/bg.jpg", "./../public/images/wl/bg2.jpg", "./../public/images/wl/face.png", "./../public/images/wl/logo.png",
    "./../public/images/wl/p1-bg.png", "./../public/images/wl/p1-btn.png", "./../public/images/wl/p2-bg.png", "./../public/images/wl/p3-bg.png", "./../public/images/wl/p4-bg.png", "./../public/images/wl/p5-bg.png", "./../public/images/wl/p6-bg.png", "./../public/images/wl/p7-bg.png", "./../public/images/wl/p7-lady.png", "./../public/images/wl/p8-bg.png", "./../public/images/wl/p9-bg.png", "./../public/images/wl/p10-bg.png",
    "./../public/images/wl/p10-img.png", "./../public/images/wl/p11-bg.png", "./../public/images/wl/p12-bg.png", "./../public/images/wl/p13-bg.png", "./../public/images/wl/p16-bg.png", "./../public/images/wl/p16-cover.png", "./../public/images/wl/p17-bg.png", "./../public/images/wl/p18-bg.png", "./../public/images/wl/share1.png", "./../public/images/wl/shares.png", "./../public/images/wl/p7-head.png", "./../public/images/wl/head2.png", "./../public/images/wl/p7-cover.png"];  //array test data
    for (var i = 1; i < 804; i++) {
        imgsstr.push("./../public/images/wl/" + i + ".png");
        if (i == 30) {
            i = 200;
        }
        if (i == 210) {
    ...
    $("#outer-container").bind("click", function (e) {
        ...
        switch ($(e.target).attr("btn")) {
            ...
            case "p3-ta":
                //$(".p7-lady-1").show();
                ta = true;                                  //Ta的味道
                $(".p7-face-1").css("backgroundImage", "url(./../public/images/wl/head21.png)");
                $("#p4").show();
                break;
            case "p3-check-mine":
                if (!checkMine) {
            ...
            case "p7-btn1":             //选衣服--》左选
                ...
                leftCheck($(".p7-clothes ul"), 206, function () {
                    ...
                    $(".p7-1").css("backgroundImage", "url(./../public/images/wl/" + (temp + 201) + ".png)");
                });
                break;
            case "p7-btn2":             //选衣服--》右选
                $(".lady").hide();
            ...
            case "p7-btn3":             //选裤子--》左选
                ...
                leftCheck($(".p7-trous ul"), 206, function () {
                    ...
                    $(".p7-2").css("backgroundImage", "url(./../public/images/wl/" + (temp + 301) + ".png)");
                });
                break;
            case "p7-btn4":             //选裤子--》右选
                $(".lady").hide();
            ...
            case "p7-btn5":             //选鞋子--》左选
                ...
                leftCheck($(".p7-shoes ul"), 206, function () {
                    ...
                    $(".p7-3").css("backgroundImage", "url(./../public/images/wl/" + (temp + 401) + ".png)");
                });
                break;
            case "p7-btn6":             //选鞋子--》右选
                $(".lady").hide();
            ...
            case "p7-change":           //一键换装
                ...
                $(".p7-lady-1").css("background", "url(./../public/images/wl/" + rd + ".png)").css("background-position", "-20px 4px").show();
                break;
            case "p7-askfor":           //泡芙小姐随机设计的一套
                ...
                $(".p7-lady-1").attr("rd", rd + "");
                $(".p7-lady-1").css("background", "url(./../public/images/wl/" + rd + ".png) no-repeat -80px 0").show();
                break;
            case "face":
                $("#p7-cover").show();
                break;
                ...
                setTimeout(function () {
                    ...
                    if (!ta) {
                        ...
                        if (!paohutaset) {
                            for (var i = 0; i < 3; i++) {
                                if (!isNaN(parseInt(rearr[i]))) {
                                    $(".p11-taste").eq(i).text("");
                                    $(".p11-taste").eq(i).css("backgroundImage", "url(./../public/images/wl/" + rearr[i] + ".png)");
                                } else {
                        ...
                        if (isboy) {
                            ...
                            $(".p11-people").css("backgroundImage", "url(./../public/images/wl/" + boy + ".png)");
                        } else {        //是女孩
                        ...
                        if (!paohutaset) {
                            for (var i = 0; i < 3; i++) {
                                if (!isNaN(parseInt(rearr[i]))) {
                                    $(".p12-taste").eq(i).text("");
                                    $(".p17-taste").eq(i).text("");
                                    $(".p12-taste").eq(i).css("backgroundImage", "url(./../public/images/wl/" + rearr[i] + ".png)");
                                    $(".p17-taste").eq(i).css("backgroundImage", "url(./../public/images/wl/" + rearr[i] + ".png)");
                                } else {
                        ...
                        if (isboy) {
                            ...
                            $(".p12-people").css("backgroundImage", "url(./../public/images/wl/" + boy + ".png)");
                            $(".p17-people .zoomgirl").hide();
                            $(".p17-people").css("backgroundImage", "url(./../public/images/wl/" + boy + ".png)");
                        } else {
                            var bg = parseInt($(".p7-lady-1").attr("rd"));
                            if (isNaN(bg)) {    //说明是正常换装
    ...
    var showClothes = function () {
        $(".p7-lady").css("backgroundImage", "url(./../public/images/wl/p7-lady.png)");
        $("#p7-tip").show();
        $(".hideclothes").show();
    ...
    himg.src = "./../public/images/wl/test.png";
    ...
    var btnTheme = function (e) {
        ...
        if (temp == 7) {
            ...
            var cimg = new Image();
            cimg.src = "./../public/images/wl/p2-bg.png";
    ...
    var loadDivImage = function () {
        for (var i = 0; i < 8; i++) {
            imgs[i].onload = function () {
                $(".theme").eq(this.index).css({ "width": this.width + "px", "height": this.height + "px", "background": "url(./../public/images/wl/theme" + (this.index + 1) + ".png) no-repeat center center", "backgroundSize": "contain", "zIndex": "1", "top": "900px" }).hide();
...
function drawAvatar(canvas) {
    ...
    headimg1.onload = function () {
        ...
        headimg2.src = "./../public/images/wl/b.png";
    }
    headimg1.src = "./../public/images/wl/a.png";
}