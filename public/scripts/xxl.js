...
//非会员结束游戏的界面按钮
    ...
    for (var i = 0; i < 3; i++) {
        $($($("#p5 ul li")[i]).find(".p5-rank")[0]).css("backgroundImage", "url(./../public/images/xxl/p5-rank-bg-" + (i + 1) + ".png");
    }
...
*/
    ...
    $("#music").bind("click", function (e) {
        ...
        if ($("#music").attr("sign") == "0") {
            ...
            $("#music").css("backgroundImage", "url(../images/xxl/music_off.png)");
            audiobg.pause();
            $("#music").attr("sign","1");
        } else {
            $("#music").addClass("mcircle");
            $("#music").css("backgroundImage", "url(../images/xxl/music_on.png)");
            $("#music").attr("sign","0");
            audiobg.play();
        }
    })
    ...
    var Game = function (time) {
        ...
        for (var i = 1; i <= 5; i++) {
            var img = new Image();
            img.src = './../public/images/xxl/' + i + '.png';
        ...
        this.showTip = function () {
            ...
            if (result.length > 0 && result[timecount] != null) {
                ...
                var div = $("<div></div>");
                div.css({ "width": "106px", "height": "123px", "position": "absolute", "z-index": "10", "backgroundImage": "url(./../public/images/xxl/hand.png)" }).appendTo(divx);
        ...
        this.del = function (imgs, callback) {
            if (this.ready) {						    //游戏消除
                for (var i = 0; i < imgs.length; i++) {   //消除前先替换图片
                    imgs[i].src = "./../public/images/xxl/circle.png";
                }
                sound.play();
    ...
    var imgsstr = ["./../public/images/xxl/bg.jpg", "./../public/images/xxl/1.png", "./../public/images/xxl/2.png", "./../public/images/xxl/3.png", "./../public/images/xxl/4.png", "./../public/images/xxl/5.png",
	               "./../public/images/xxl/p2-bg.png", "./../public/images/xxl/p3-bg.png", "./../public/images/xxl/p3-line.png", "./../public/images/xxl/p4-bg.png", "./../public/images/xxl/p4-bg.png", "./../public/images/xxl/p5-rank-bg-1.png",
	               "./../public/images/xxl/p5-rank-bg-2.png", "./../public/images/xxl/p5-rank-bg-3.png", "./../public/images/xxl/circle.png", "./../public/images/xxl/hand.png", "./../public/images/xxl/p6-bg.png", "./../public/images/xxl/p1-bg.jpg",
	              "./../public/images/xxl/p1-cars.png", "./../public/images/xxl/p1-circle.png", "./../public/images/xxl/p1-rank.png", "./../public/images/xxl/p1-red.png", "./../public/images/xxl/p1-road.png", "./../public/images/xxl/p1-rule.png", "./../public/images/xxl/p1-something.png",
	               "./../public/images/xxl/p1-star.png", "./../public/images/xxl/p1-start.png", "./../public/images/xxl/p1-words.png", "./../public/images/xxl/score1.png", "./../public/images/xxl/gamecount.png", "./../public/images/xxl/music_off.png",
                   "./../public/images/xxl/music_on.png","./../public/images/xxl/p7-bg.png","./../public/images/xxl/p8-again.png"];
