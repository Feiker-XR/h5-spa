$(function () {
    ...
    $(".music").bind("click", function () {
        if (!isplay) {
            music.pause();
            $(".music").css("backgroundImage", "url(img/music_off.png)");
            isplay = !isplay;
        } else {
            music.play();
            $(".music").css("backgroundImage", "url(img/music_on.png)");
            isplay = !isplay;
        }
    })
    ...
    $("#p7").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            //$(".p8-circle-once").css("backgroundImage", "url(img/circle-once.gif?" + gif + ")");
            //gif++;
    ...
    $("#p8").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            //$(".p9-circle-once").css("backgroundImage", "url(img/circle-once.gif?" + gif + ")");
            //gif++;
            ...
            //p7
            //$(".p8-circle-once").css("backgroundImage", "none");
            //$(".p7-circle-once").css("backgroundImage", "url(img/circle-once.gif?" + gif + ")");
            //gif++;
            $(".p8-circle-once img").remove();
            //$(".p7-circle-once").append("<img src='img/circle-once.gif?" + gif + "'/>");
            //gif++;
    ...
    $("#p9").bind("touchend", function (e) {
        if (startY - endY > 100 && endY != null) {
            ...
            //$(".p10-circle-once").css("backgroundImage", "url(img/circle-once.gif?" + gif + ")");
            //gif++;
    ...
    function enterP4() {
        ...
        $("#arrow").hide();
        $("#logo").css("backgroundImage", "url(img/logo3.png)");
    ...
    function enterP6() {
        ...
        $(".p6-img-c").fadeIn(1000, function () {
            ...
            $(".p6-car").animate({ "left": "0px" }, 1500, function () {
                $(".p6-car").css("backgroundImage", "url(img/p6-car.png)");
    ...
    function enterP10() {
        ...
        //$(".p10-circle-once").css("backgroundImage","url(img/circle-once.gif?"+gif+")");
        //gif++;
        $(".p10-img-1").css("backgroundImage", "url(img/p10-img-1.png)");
        $("#p10").removeClass("scaleSmallPage").addClass("scaleBigPage").show(0, function () {
            ...
            setTimeout(function () {
                ...
                $(".p10-img-1-1").animate({ "bottom": "724px" }, 1000, function () {
                    $(".p10-img-1").css("backgroundImage", "url(img/p10-img-1-2.png)");
                });
    ...
    var imgsstr = ["img/arrow.png", "img/logo.png", "img/logo2.png", "img/music_off.png", "img/music_on.png", "img/p1-bg-1.jpg",
	"img/p1-word.png", "img/p2-img.jpg", "img/p2-img-1.png", "img/p2-rotate.gif", "img/p2-words.png", "img/p3-img.jpg", "img/p3-words.png", "img/p4-bg.gif",
	"img/p4-start.png", "img/p4-word-1.png", "img/p4-word-2.png", "img/p5-bg.png", "img/p5-img-1.png", "img/p5-img-2.png", "img/p5-img-4.png",
	"img/p5-img-5.png", "img/p5-title.png", "img/p5-word.png", "img/p6-bg.jpg", "img/p6-car.png", "img/p6-img.jpg", "img/p6-title.png", "img/p6-words.png",
	"img/p7-img-1.png", "img/p7-img-2.png", "img/p7-title.png", "img/p7-words.png", "img/p8-bg.jpg", "img/p8-img-1.png", "img/p8-img-2.png", "img/p8-title.png",
	"img/p8-words.png", "img/p9-img-1.jpg", "img/p9-img-2.jpg", "img/p9-title.png", "img/p9-words.png", "img/p10-img-1.png", "img/p10-img-3.png",
	"img/p10-title.png", "img/p10-words.png", "img/p11-bg.jpg", "img/p11-name.png", "img/p11-title.png", "img/p11-words.png", "img/share.jpg", "img/busy.gif",

	"img/p6-car-1.png", "img/p6-img-c.png", "img/p10-img-1-1.png", "img/p10-img-1-2.png", "img/p10-img-2.png",
	"img/p10-img-4.png", "img/p10-img-5.png", "img/circle-once.gif", "img/logo3.png", "img/logo4.png"];
